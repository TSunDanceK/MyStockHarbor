...
// #563 COWORK #1 D1), against the live SEC manifest and fact sets.
//   mode=dry  (default) print the record's sectors and counts. Redis: 1 GET of
//             the manifest and one MGET per 100 fact sets; no write.
...
if (r) {
  console.log(`years ${r.years.join(",")}; companies ${r.companiesRead}; other currency ${r.otherCurrency}; unclassified ${r.unclassified}; partial capex history ${r.partial}`);
