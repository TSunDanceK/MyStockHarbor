...
for (const symbol of UNIVERSE) {
  ...
  results.push({ symbol, isFpi, pairs, pagesRead, cappedPaging: pagesRead >= 2 });
...
console.log(`  of those, ${excluded.filter((r) => r.cappedPaging).length} hit the paging cap — thin history may be the CAP, not the filer\n`);
line("ALL", all);
line("domestic", dom);
line("FPI", fpi);
