    ...
    <>
      ...
      <main style={{ minHeight: "100vh", background: "#06080d", color: "#f1f5f9", fontFamily: "system-ui, Arial" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "28px 20px 40px" }}>
          ...
          <section style={{ marginTop: 28 }}><h2>2. Indicators used to spot bearish divergence</h2><p style={{ marginTop: 12, lineHeight: 1.7, opacity: 0.86 }}>The same oscillators used for bullish divergence apply here:</p><ul style={{ marginTop: 10 }}><li><Link href="/learn/rsi" style={{ color: "#93c5fd", textDecoration: "underline" }}>RSI</Link></li><li><Link href="/learn/macd" style={{ color: "#93c5fd", textDecoration: "underline" }}>MACD</Link></li></ul></section>
