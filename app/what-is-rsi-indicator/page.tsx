...
const TITLE = "What Is RSI Indicator?";
const DESC = "Learn what the RSI indicator is, how it works, what overbought and oversold mean, and how beginners can use RSI to read stock charts more clearly.";
const PATH = "/what-is-rsi-indicator";
