  ...
  return (
    <main style={{ minHeight: "100vh", background: "radial-gradient(circle at top left, rgba(37,99,235,0.18), transparent 22%), radial-gradient(circle at top right, rgba(34,197,94,0.10), transparent 22%), #06080d", color: "#f1f5f9", fontFamily: "system-ui, Arial" }}>
      ...
      <style>{`
        ...
        .compactNewsRow { display: grid; grid-template-columns: minmax(80px, max-content) minmax(0, 1fr) 64px; gap: 12px; align-items: start; }
...
const compactNewsRowStyle: CSSProperties = { display: "grid", gridTemplateColumns: "minmax(80px, max-content) minmax(0, 1fr) 64px", gap: 12, alignItems: "start", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 14, padding: 12, background: "rgba(255,255,255,0.02)" };
