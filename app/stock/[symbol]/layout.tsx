...
//
// IF THIS PRODUCES NO CACHE HIT, the cause is upstream and this line is a
// no-op: the @upstash/redis client issues its REST calls with
// `cache: "no-store"`, which opts an entire route out of static rendering,
// and getDailyHistory() reads Redis on every render of the overview page.
// The fix in that case is to wrap the Redis-backed reads in unstable_cache,
// the pattern lib/youtube.ts already uses.
