...
const DESC = "Learn how to analyse stocks using technical and fundamental methods, including trend, momentum indicators, earnings, and valuation for smarter investing decisions.";
...
export { default } from "./HowToAnalyseStocksPage";
