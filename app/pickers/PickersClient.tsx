...
// Routes "Open chart" links to /dashboard instead of / so mobile users
// land on the chart dashboard, not the new mobile home page.
...
function PlayDiagram({ pattern, tone }: { pattern: PlayCardDef["pattern"]; tone: PlayCardDef["tone"] }) {
  ...
  if (pattern === "descending") {
    return (
      <svg viewBox="0 0 320 138" className="playDiagram" role="img" aria-label="Descending triangle diagram">
        ...
        <path d="M42 108 H282" stroke={colors.line} strokeWidth="3" strokeDasharray="7 7" strokeLinecap="round" />
        <path d="M44 38 L282 108" stroke={colors.accent} strokeWidth="3" strokeLinecap="round" />
        <path d="M46 44 L74 108 L104 56 L132 108 L162 72 L190 108 L220 88 L250 108 L278 105" stroke="rgba(226,232,240,0.80)" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M52 126 V114 M86 126 V115 M120 126 V112 M154 126 V115 M188 126 V112 M222 126 V115 M256 126 V113 M290 126 V116" stroke="rgba(59,130,246,0.30)" strokeWidth="5" strokeLinecap="round" />
      </svg>
    );
  }
  ...
  if (pattern === "macroSR") {
    return (
      <svg viewBox="0 0 320 138" className="playDiagram" role="img" aria-label="Macro support and resistance diagram">
        <rect x="0" y="0" width="320" height="138" rx="16" fill="rgba(2,6,23,0.72)" />
        <path d="M36 36 H284" stroke="#ef4444" strokeWidth="4" strokeDasharray="8 7" strokeLinecap="round" />
        <path d="M36 102 H284" stroke="#22c55e" strokeWidth="4" strokeDasharray="8 7" strokeLinecap="round" />
        <path d="M44 91 L72 64 L100 96 L130 72 L160 39 L190 76 L220 101 L250 73 L278 50" stroke="rgba(226,232,240,0.82)" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M52 126 V113 M86 126 V104 M120 126 V111 M154 126 V91 M188 126 V101 M222 126 V113 M256 126 V98 M290 126 V86" stroke="rgba(59,130,246,0.30)" strokeWidth="5" strokeLinecap="round" />
      </svg>
    );
  }
  ...
  if (pattern === "bullFlag") {
    return (
      <svg viewBox="0 0 320 138" className="playDiagram" role="img" aria-label="Bull flag diagram">
        <rect x="0" y="0" width="320" height="138" rx="16" fill="rgba(2,6,23,0.72)" />
        <path d="M34 108 L62 96 L84 73 L104 36" stroke="#22c55e" strokeWidth="5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M106 36 L144 52 L184 46 L222 61 L262 54" stroke="rgba(226,232,240,0.80)" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M108 34 L272 53" stroke={colors.line} strokeWidth="3" strokeDasharray="7 7" strokeLinecap="round" />
        <path d="M102 66 L266 85" stroke={colors.line} strokeWidth="3" strokeDasharray="7 7" strokeLinecap="round" />
        <path d="M262 54 L292 36" stroke="#22c55e" strokeWidth="4" strokeLinecap="round" />
        <path d="M292 36 L276 37 M292 36 L286 51" stroke="#22c55e" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M42 126 V112 M76 126 V101 M110 126 V84 M144 126 V103 M178 126 V97 M212 126 V106 M246 126 V100 M280 126 V94" stroke="rgba(59,130,246,0.30)" strokeWidth="5" strokeLinecap="round" />
      </svg>
    );
  }
  ...
  return (
    <svg viewBox="0 0 320 138" className="playDiagram" role="img" aria-label="Ascending triangle diagram">
      <rect x="0" y="0" width="320" height="138" rx="16" fill="rgba(2,6,23,0.72)" />
      <path d="M42 36 H282" stroke={colors.line} strokeWidth="3" strokeDasharray="7 7" strokeLinecap="round" />
      <path d="M44 108 L282 36" stroke={colors.accent} strokeWidth="3" strokeLinecap="round" />
      <path d="M46 94 L76 36 L106 84 L136 36 L166 72 L196 36 L226 58 L256 36 L282 38" stroke="rgba(226,232,240,0.80)" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M52 126 V114 M86 126 V105 M120 126 V112 M154 126 V99 M188 126 V108 M222 126 V92 M256 126 V100 M290 126 V84" stroke="rgba(59,130,246,0.30)" strokeWidth="5" strokeLinecap="round" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "flex-end", flexWrap: "wrap" }}>
        <div>
          <div style={{ display: "inline-flex", alignItems: "center", padding: "7px 11px", borderRadius: 999, border: "1px solid rgba(96,165,250,0.28)", background: "rgba(59,130,246,0.10)", color: "#dbeafe", fontSize: 11, fontWeight: 950, letterSpacing: "0.08em", textTransform: "uppercase" }}>
            Chart pattern plays
          </div>
          <h2 style={{ margin: "12px 0 0", fontSize: 25, lineHeight: 1.12, letterSpacing: "-0.035em" }}>Pattern setups that need the chart</h2>
          <p style={{ margin: "8px 0 0", maxWidth: 760, color: "rgba(226,232,240,0.74)", fontSize: 14, lineHeight: 1.65 }}>
            These are visual chart-pattern pages, so the cards below act as quick links into the full play pages rather than simple ticker lists.
          </p>
        </div>
      </div>
...
export default function PickersClient() {
  ...
  useEffect(() => {
    try {
      ...
      if (Number.isFinite(saved) && saved > Date.now()) setEarningsFetchLockedUntil(saved);
    } catch { /* ignore */ }
  }, []);
  ...
  const enrichedSignalRecords = useMemo(() => {
    ...
    for (const record of safeSignalRecords) {
      ...
      map.set(symbol, {
        ...record,
        symbol,
        positiveLastEarnings: record.positiveLastEarnings === true || earningsSectionSymbolSets.positiveLastEarnings.has(symbol),
        strongEarningsGrowth: record.strongEarningsGrowth === true || earningsSectionSymbolSets.strongEarningsGrowth.has(symbol),
      });
    }
    for (const section of safeSections) {
      const title = String(section.title || "").toLowerCase();
      ...
      for (const item of Array.isArray(section.items) ? section.items : []) {
        ...
        map.set(symbol, {
          ...
          positiveLastEarnings: existing.positiveLastEarnings === true || isPositiveLastEarnings,
          strongEarningsGrowth: existing.strongEarningsGrowth === true || isStrongEarningsGrowth,
        });
      }
    }
  ...
  const dynamicSymbolSet = useMemo(() => {
    return new Set(dynamicSymbols.map((x) => String(x).trim().toUpperCase()).filter(Boolean));
  }, [dynamicSymbols]);

  const topBuySection = useMemo<PickerSection | null>(() => {
    const items = safeSignalRecords
      .map((record) => ({ symbol: record.symbol, buyCount: getBuySignalCount(record), dashboardHref: toChartHref(record.dashboardHref ?? "", record.symbol) }))
      .filter((item) => item.buyCount > 0)
      .sort((a, b) => b.buyCount !== a.buyCount ? b.buyCount - a.buyCount : a.symbol.localeCompare(b.symbol))
      .slice(0, 4)
      .map((item) => ({ symbol: item.symbol, note: `${item.buyCount} buy signal${item.buyCount === 1 ? "" : "s"}`, tone: "green" as PickerTone, dashboardHref: item.dashboardHref }));
  ...
  const topSellSection = useMemo<PickerSection | null>(() => {
    const items = safeSignalRecords
      .map((record) => ({ symbol: record.symbol, sellCount: getSellSignalCount(record), dashboardHref: toChartHref(record.dashboardHref ?? "", record.symbol) }))
      .filter((item) => item.sellCount > 0)
      .sort((a, b) => b.sellCount !== a.sellCount ? b.sellCount - a.sellCount : a.symbol.localeCompare(b.symbol))
      .slice(0, 4)
      .map((item) => ({ symbol: item.symbol, note: `${item.sellCount} sell signal${item.sellCount === 1 ? "" : "s"}`, tone: "red" as PickerTone, dashboardHref: item.dashboardHref }));
    if (!items.length) return null;
  ...
  const displaySections = useMemo(() => {
    ...
    const ma200Section = safeSections.find((s) => s.title.toLowerCase().includes("200-day"));
    const buyTheDipSection = safeSections.find((s) => s.title.includes("All-Time Highs"));
    const athBreakoutSection = safeSections.find((s) => s.title.includes("All-Time High Breakout"));
    const threeMonthBreakoutSection = safeSections.find((s) => s.title.includes("3-Month High Breakout"));
    const oversoldSection = safeSections.find((s) => s.title.toLowerCase().includes("oversold"));
    const macroSupportResistanceSection = safeSections.find((s) => { const t = s.title.toLowerCase(); return t.includes("macro") && t.includes("support") && t.includes("resistance"); });
    const otherSections = safeSections.filter((s) => s !== ma200Section && s !== buyTheDipSection && s !== athBreakoutSection && s !== threeMonthBreakoutSection && s !== oversoldSection && s !== macroSupportResistanceSection && !s.title.toLowerCase().includes("hot market names"));
  ...
  const customMatches = useMemo(() => {
    ...
    return enrichedSignalRecords
      ...
      .map((record) => {
        ...
        return { ...record, matchedSignals, displayTone: chooseCardTone(record, matchedSignals) };
      })
      .sort((a, b) => {
  ...
  .pickers-shell { width: 100%; max-width: 1280px; min-width: 0; }
  .pickers-sections-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 16px; align-items: start; }
  .pattern-plays-grid { margin-top: 16px; display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 14px; }
  .pattern-play-card { display: grid; grid-template-rows: auto 1fr; gap: 12px; padding: 12px; border-radius: 18px; text-decoration: none; min-width: 0; box-sizing: border-box; box-shadow: inset 0 1px 0 rgba(255,255,255,0.035); transition: transform 150ms ease, filter 150ms ease, border-color 150ms ease; }
  .pattern-play-card:hover { transform: translateY(-2px); filter: brightness(1.08); }
  .playDiagram { width: 100%; display: block; border-radius: 16px; border: 1px solid rgba(255,255,255,0.08); background: rgba(2,6,23,0.64); }
  .pattern-play-copy h3 { margin: 0; font-size: 17px; line-height: 1.18; letter-spacing: -0.025em; }
  .pattern-play-copy p { margin: 8px 0 0; color: rgba(226,232,240,0.72); font-size: 13px; line-height: 1.55; }
  .pattern-play-button { margin-top: 12px; min-height: 36px; padding: 8px 11px; display: inline-flex; align-items: center; justify-content: center; border-radius: 11px; border: 1px solid; font-size: 12px; font-weight: 950; }
  .pickers-filter-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(190px, 1fr)); gap: 10px; }
  .pickers-card-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 12px; }
  .pickers-section-results-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px; }
  ...
  @media (max-width: 980px) { .pickers-sections-grid { grid-template-columns: minmax(0, 1fr); } .pattern-plays-grid { grid-template-columns: minmax(0, 1fr); } .pattern-play-card { grid-template-columns: 170px minmax(0, 1fr); grid-template-rows: auto; align-items: center; } }
  @media (max-width: 820px) { .pickers-filter-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); } .pickers-card-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); } }
  .pickers-desktop-only { display: block; }
  @media (max-width: 640px) { .pickers-filter-grid, .pickers-card-grid, .pickers-section-results-grid, .pickers-sections-grid { grid-template-columns: minmax(0, 1fr); } .pickers-desktop-only { display: none; } .pickers-section-description { display: none; } .pickers-item-note { display: none !important; } .pickers-item-note.pickers-item-note-show-mobile { display: inline !important; } .pickers-note-mobile { display: none; } .pickers-note-desktop { display: inline; } .pickers-section-title { flex-wrap: nowrap !important; align-items: center !important; gap: 8px !important; } .pickers-help-tip { width: 22px !important; height: 22px !important; font-size: 13px !important; margin-left: 0 !important; flex: 0 0 22px !important; } .pickers-note-desktop { display: none; } .pickers-note-mobile { display: inline; } .pattern-play-card { grid-template-columns: minmax(0, 1fr); } }
`}</style>
      ...
      {err ? (
        <div className="pickers-shell" style={{ border: "1px solid rgba(239,68,68,0.18)", borderRadius: 16, padding: 16, background: "rgba(239,68,68,0.08)", color: "#fecaca", boxSizing: "border-box" }}>{err}</div>
      ) : null}

      {!loading && !err ? (
        <section className="pickers-shell pickers-desktop-only" style={{ border: "1px solid rgba(34,197,94,0.26)", borderRadius: 18, padding: 16, background: "linear-gradient(180deg, rgba(8,18,12,0.96), rgba(8,12,22,1))", marginBottom: 18, boxSizing: "border-box", overflow: "hidden" }}>
          <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "flex-start", flexWrap: "wrap" }}>
            <div style={{ minWidth: 0 }}>
              <h3 style={{ margin: 0, fontSize: 24, lineHeight: 1.1, letterSpacing: "-0.03em" }}>Build your own stock setup</h3>
              <p style={{ margin: "8px 0 0 0", fontSize: 14, lineHeight: 1.65, opacity: 0.76, maxWidth: 760 }}>Choose multiple technical conditions and we will only show stocks matching all selected filters.</p>
            </div>
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center" }}>
              <button type="button" onClick={handleScreenerButton} style={{ ...actionButtonStyle, border: "1px solid rgba(34,197,94,0.34)", background: "linear-gradient(180deg, rgba(20,83,45,0.98), rgba(21,128,61,0.88))", color: "#dcfce7", boxShadow: screenerOpen ? "0 0 0 1px rgba(34,197,94,0.16), 0 10px 24px rgba(22,101,52,0.18)" : "none" }}>
                {screenerOpen ? "Hide Custom Screener" : "Custom Screener"}
              </button>
              {customMode ? (
                <button type="button" onClick={clearFilters} style={{ ...actionButtonStyle, border: "1px solid rgba(239,68,68,0.34)", background: "linear-gradient(180deg, rgba(127,29,29,0.98), rgba(185,28,28,0.88))", color: "#fee2e2", boxShadow: "0 10px 24px rgba(127,29,29,0.16)" }}>Clear Filters</button>
              ) : null}
            </div>
          </div>

          <div style={{ marginTop: screenerOpen ? 16 : 0, maxHeight: screenerOpen ? 1200 : 0, opacity: screenerOpen ? 1 : 0, overflow: "hidden", transform: screenerOpen ? "translateY(0)" : "translateY(-8px)", transition: "max-height 0.38s ease, opacity 0.24s ease, transform 0.28s ease, margin-top 0.28s ease" }}>
            <div className="pickers-filter-grid">
              {FILTER_DEFS.map((filter) => {
                const active = selectedFilters.includes(filter.key);
                return (
                  <button key={filter.key} type="button" onClick={() => toggleFilter(filter.key)} style={{ display: "flex", alignItems: "center", gap: 10, padding: "12px 14px", minWidth: 0, borderRadius: 14, border: active ? `1px solid ${toneDot(filter.tone)}` : "1px solid rgba(255,255,255,0.14)", background: active ? "rgba(255,255,255,0.08)" : "rgba(255,255,255,0.04)", color: "#f1f5f9", textAlign: "left", fontWeight: 850, cursor: "pointer", boxSizing: "border-box" }}>
                    <span style={{ width: 10, height: 10, borderRadius: 999, background: toneDot(filter.tone), flex: "0 0 auto" }} />
            ...
            {customMode ? (
              <div style={{ marginTop: 16, padding: 14, borderRadius: 14, border: "1px solid rgba(255,255,255,0.10)", background: "rgba(255,255,255,0.04)", boxSizing: "border-box" }}>
                <div style={{ fontSize: 12, opacity: 0.72, fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.05em" }}>Active Custom Setup</div>
                <div style={{ marginTop: 10, display: "flex", gap: 8, flexWrap: "wrap" }}>
                  {selectedFilters.map((filter) => {
                    const def = FILTER_DEFS.find((f) => f.key === filter);
                    return (
                      <span key={filter} style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "8px 10px", borderRadius: 999, border: "1px solid rgba(255,255,255,0.14)", background: "rgba(255,255,255,0.06)", fontSize: 12, fontWeight: 900 }}>
                        <span style={{ width: 8, height: 8, borderRadius: 999, background: toneDot(def?.tone) }} />
      ...
      <div className="pickers-shell" style={{ marginTop: loading || err ? 20 : 0, display: "grid", gap: 16, boxSizing: "border-box" }}>
        ...
        {customMode ? (
                  ...
                  <a key={item.symbol} href={toChartHref(item.dashboardHref ?? "", item.symbol)} style={{ display: "block", minWidth: 0, textDecoration: "none", color: "#f1f5f9", border: "1px solid rgba(255,255,255,0.14)", borderRadius: 16, padding: 14, background: "rgba(255,255,255,0.04)", boxSizing: "border-box" }} title={`View ${item.symbol} chart`}>
                      ...
                      <div style={{ minWidth: 0 }}>
                        ...
                        {item.preferredTimeframe || item.preferredIndicator ? (
                          <div style={{ marginTop: 8, display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
                            {item.preferredTimeframe ? <span style={{ display: "inline-flex", alignItems: "center", padding: "5px 8px", borderRadius: 999, border: "1px solid rgba(255,255,255,0.12)", background: "rgba(255,255,255,0.05)", fontSize: 10, fontWeight: 900, letterSpacing: "0.04em" }}>{item.preferredTimeframe}</span> : null}
                            {item.preferredIndicator ? <span style={{ display: "inline-flex", alignItems: "center", padding: "5px 8px", borderRadius: 999, border: "1px solid rgba(96,165,250,0.22)", background: "rgba(59,130,246,0.08)", color: "#dbeafe", fontSize: 10, fontWeight: 900, letterSpacing: "0.04em" }}>{item.preferredIndicator}</span> : null}
                          </div>
                        ) : null}
                    ...
                    <div style={{ marginTop: 12, display: "flex", gap: 8, flexWrap: "wrap" }}>
                      {item.matchedSignals.map((signal) => {
                        ...
                        return (
                          <span key={`${item.symbol}-${signal}`} style={{ display: "inline-flex", alignItems: "center", gap: 7, padding: "7px 9px", borderRadius: 999, border: "1px solid rgba(255,255,255,0.12)", background: "rgba(255,255,255,0.05)", fontSize: 11, fontWeight: 900, minWidth: 0 }}>
                            <span style={{ width: 7, height: 7, borderRadius: 999, background: toneDot(def?.tone), flex: "0 0 auto" }} />
          ...
          <div className="pickers-sections-grid pickers-shell">
            {displaySections.map((sec) => {
              ...
              return (
                <section key={sec.title} style={{ border: "1px solid rgba(255,255,255,0.14)", borderRadius: 16, padding: 16, background: "#0b1220", boxSizing: "border-box", overflow: "visible" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "baseline", flexWrap: "wrap" }}>
                    <div style={{ minWidth: 0 }}>
                      <h2 className="pickers-section-title" style={{ margin: 0, fontSize: 22, fontWeight: 950, letterSpacing: "-0.02em", display: "flex", alignItems: "center", gap: 8, flexWrap: "nowrap" }}>
                        <span className="pickers-section-title-text">{sec.title}</span>
                        <HelpTip text={getHeaderHelp(sec.title)} />
                      </h2>
                      {sec.description ? <p className="pickers-section-description" style={{ margin: "8px 0 0", fontSize: 14, opacity: 0.72, lineHeight: 1.6 }}>{sec.description}</p> : null}
                    </div>
                    <div style={{ fontSize: 12, opacity: 0.7 }}>{typeof sec.foundCount === "number" ? `F${sec.foundCount} / S${items.length}` : items.length ? `${items.length} stocks` : "No matches yet"}</div>
                  </div>

                  <div className="pickers-section-results-grid" style={{ marginTop: 14 }}>
                    {items.map((it) => (
                      <div key={it.symbol} style={{ display: "grid", gridTemplateColumns: "minmax(0, 1fr) auto", alignItems: "center", gap: 10, border: "1px solid rgba(255,255,255,0.14)", borderRadius: 16, padding: 12, background: "rgba(255,255,255,0.04)", boxSizing: "border-box" }}>
                        <a href={toChartHref(it.dashboardHref ?? "", it.symbol)} style={{ display: "block", minWidth: 0, maxWidth: "100%", color: "#f1f5f9", textDecoration: "none", fontWeight: 900, overflow: "hidden" }} title={it.note ?? "Open in dashboard"}>
                          <span style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0 }}>
                            <span style={{ width: 10, height: 10, borderRadius: 999, background: toneDot(it.tone), boxShadow: "0 0 0 3px rgba(255,255,255,0.04)", flex: "0 0 auto" }} />
                            <span style={{ minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{it.symbol}</span>
                          </span>
                          {it.note ? (
                            <span className={`pickers-item-note${/MA200/i.test(it.note) ? " pickers-item-note-show-mobile" : ""}`} style={{ display: "block", marginTop: 5, paddingLeft: 18, fontSize: 11, lineHeight: 1.35, opacity: 0.68, fontWeight: 750, minWidth: 0, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                        ...
                        <a href={toChartHref(it.dashboardHref ?? "", it.symbol)} style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", padding: "8px 11px", borderRadius: 10, background: "rgba(148,163,184,0.06)", border: "1px solid rgba(148,163,184,0.18)", color: "#cbd5f5", textDecoration: "none", fontSize: 12, fontWeight: 900, whiteSpace: "nowrap", flex: "0 0 auto" }} title={`Open ${it.symbol} chart`}>Open chart \u2197</a>
                      </div>
                    ))}
                  </div>
                  ...
                  {(() => {
                    ...
                    if (title.includes("positive last earnings")) { seoHref = "/stocks-with-positive-last-earnings"; seoLabel = "See all positive earnings stocks \u2192"; seoBorder = "1px solid rgba(34,197,94,0.22)"; seoBackground = "rgba(34,197,94,0.08)"; seoColor = "#dcfce7"; }
                    else if (title.includes("strong earnings growth")) { seoHref = "/stocks-with-strong-earnings-growth"; seoLabel = "See all earnings growth stocks \u2192"; seoBorder = "1px solid rgba(34,197,94,0.22)"; seoBackground = "rgba(34,197,94,0.08)"; seoColor = "#dcfce7"; }
                    else if (title.includes("all-time high breakout")) { seoHref = "/all-time-high-breakout-stocks"; seoLabel = "See all ATH breakout stocks \u2192"; seoBorder = "1px solid rgba(251,146,60,0.22)"; seoBackground = "rgba(251,146,60,0.08)"; seoColor = "#fed7aa"; }
                    else if (title.includes("3-month high breakout")) { seoHref = "/3-month-high-breakout-stocks"; seoLabel = "See all 3-month high breakout stocks \u2192"; seoBorder = "1px solid rgba(251,146,60,0.22)"; seoBackground = "rgba(251,146,60,0.08)"; seoColor = "#fed7aa"; }
                    else if (title.includes("all-time highs")) { seoHref = "/stocks-down-20-from-all-time-highs"; seoLabel = "See all stocks down from all-time highs \u2192"; seoBorder = "1px solid rgba(234,179,8,0.22)"; seoBackground = "rgba(234,179,8,0.08)"; seoColor = "#fef3c7"; }
                    else if (title.includes("macro") && title.includes("support") && title.includes("resistance")) { seoHref = "/macro-support-resistance-stocks"; seoLabel = "See all macro support and resistance stocks \u2192"; seoBorder = "1px solid rgba(96,165,250,0.24)"; seoBackground = "rgba(59,130,246,0.09)"; seoColor = "#dbeafe"; }
                    else if (title.includes("buy signals")) { seoHref = "/top-stocks-with-buy-signals"; seoLabel = "See all buy signal stocks \u2192"; seoBorder = "1px solid rgba(34,197,94,0.22)"; seoBackground = "rgba(34,197,94,0.08)"; seoColor = "#dcfce7"; }
                    else if (title.includes("sell signals")) { seoHref = "/top-stocks-with-sell-signals"; seoLabel = "See all sell signal stocks \u2192"; seoBorder = "1px solid rgba(239,68,68,0.22)"; seoBackground = "rgba(239,68,68,0.08)"; seoColor = "#fecaca"; }
                    else if (title.includes("oversold")) { seoHref = "/oversold-stocks-today"; seoLabel = "See all oversold stocks today \u2192"; seoBorder = "1px solid rgba(34,197,94,0.22)"; seoBackground = "rgba(34,197,94,0.08)"; seoColor = "#dcfce7"; }
                    else if (title.includes("overbought")) { seoHref = "/overbought-stocks-today"; seoLabel = "See all overbought stocks today \u2192"; seoBorder = "1px solid rgba(239,68,68,0.22)"; seoBackground = "rgba(239,68,68,0.08)"; seoColor = "#fecaca"; }
                    else if (title.includes("best trend score")) { seoHref = "/best-trend-score-stocks"; seoLabel = "See all best trend score stocks \u2192"; seoBorder = "1px solid rgba(34,197,94,0.22)"; seoBackground = "rgba(34,197,94,0.08)"; seoColor = "#dcfce7"; }
                    else if (title.includes("divergence")) { seoHref = "/bullish-bearish-divergence-stocks"; seoLabel = "See all divergence stocks \u2192"; seoBorder = "1px solid rgba(168,85,247,0.22)"; seoBackground = "rgba(168,85,247,0.08)"; seoColor = "#f3e8ff"; }
                    else if (title.includes("200")) { seoHref = "/stocks-near-200-day-moving-average"; seoLabel = "See all stocks near 200-day MA \u2192"; }
                    if (!seoHref) return null;
                    return (
                      <div style={{ marginTop: 12, display: "flex", justifyContent: "flex-end", position: "relative", zIndex: 1 }}>
                        <a href={seoHref} className="pickers-more-link" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", padding: "8px 12px", borderRadius: 10, border: seoBorder, background: seoBackground, color: seoColor, textDecoration: "none", fontSize: 12, fontWeight: 900, whiteSpace: "nowrap" }}>{seoLabel}</a>
                      </div>
                    );
                  })()}
                </section>
