...
const SETUP_LINKS: { label: string; href: string }[] = [
  ...
  { label: "Bullish Trend Flip (Daily)", href: "/stocks-with-bullish-trend-flip" },
  { label: "Bearish Trend Flip (Daily)", href: "/stocks-with-bearish-trend-flip" },
  { label: "Bullish Trend Flip (Weekly)", href: "/stocks-with-weekly-bullish-trend-flip" },
  { label: "Bearish Trend Flip (Weekly)", href: "/stocks-with-weekly-bearish-trend-flip" },
