      ...
      <div className="wrap">
        ...
        >
          ...
          >
            <HighlightCard
              title="Price"
              text="Pushes to a lower low."
              tint="red"
            />
            <HighlightCard
              title="Momentum"
              text="Makes a higher low or a less weak reading."
              tint="blue"
            />
            <HighlightCard
              title="Idea"
              text="Sellers may be losing control even before price turns."
              tint="green"
            />
          </div>
        </section>
        ...
        >
          <ContentSection
            number="1"
            title="What is bullish divergence in stocks?"
            tint="green"
          >
          ...
          <ContentSection
            number="2"
            title="Indicators often used for bullish divergence"
            tint="purple"
          >
            <div
              style={{
            ...
            >
              <IndicatorCard
                ...
                text="Price makes a lower low while RSI makes a higher low or refuses to confirm the same downside extreme."
              />
              <IndicatorCard
                title="MACD divergence"
                text="Price weakens further, but MACD momentum does not make an equally weak new low."
              />
              <IndicatorCard
                title="Stochastic or other momentum tools"
                text="Other oscillators can also reveal when downside momentum is no longer confirming fresh weakness in price."
              />
            </div>
          </ContentSection>
          ...
          <ContentSection
            number="3"
            title="Why traders look for bullish divergence"
            tint="blue"
          >
            <div
              style={{
            ...
            >
              <BulletRow text="It can help identify early reversal candidates." />
              <BulletRow text="It may reveal fading downside momentum." />
              <BulletRow text="It works well alongside oversold conditions and support." />
              <BulletRow text="It can help traders avoid assuming every lower low means growing weakness." />
            </div>
          ...
          <ContentSection
            number="4"
            title="The biggest mistake with bullish divergence"
            tint="red"
          >
            <p style={paragraphStyle}>
          ...
          <ContentSection
            number="5"
            title="How MyStockHarbor helps you find bullish divergence stocks"
            tint="amber"
          >
            <p style={paragraphStyle}>
