          ...
          >
            ...
            <div>
              ...
              {stockData?.companyName && (
                <p style={{ margin: "0 0 18px", opacity: 0.7, fontSize: 15 }}>
                  {stockData.companyName}
                </p>
              )}
                ...
                <div style={{
                  ...
                  {statItems.map(({ label, value }) => (
                    <div key={label} style={{
                      ...
                      <div style={{ fontSize: 10, opacity: 0.6, fontWeight: 700, marginBottom: 3, textTransform: "uppercase", letterSpacing: "0.04em" }}>
                        {label}
                      </div>
                      <div style={{ fontSize: 17, fontWeight: 900, letterSpacing: "-0.2px" }}>
                        {value}
                      </div>
                    </div>
                  ))}
              ...
              <div style={{
                ...
                opacity: 0.5, lineHeight: 1.6, marginBottom: 24,
              }}>
