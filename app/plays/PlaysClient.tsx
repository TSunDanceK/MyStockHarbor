...
export default function PlaysClient({
  ...
  useEffect(() => {
    ...
    if (forceInitialLoad) {
      ...
      // (see app/plays/page.tsx). In that case, refresh quietly in the
      // background instead of re-showing the loading skeleton.
  ...
  return (
    <ScreenerShell
      currentHref="/plays"
      tone="blue"
      eyebrow="Ascending triangle screener"
      title="Ascending Triangle Stocks"
      description="Stocks pressing a flat resistance while their lows keep rising — daily and weekly ascending-triangle candidates from the chart-pattern scanner."
      explainerTitle="How to use ascending triangle plays"
      explainerBody="Ascending triangles form when price keeps testing a flat resistance while the lows step higher into it. A clean break above resistance on strong volume is the classic trigger — but treat these as candidates to review on the chart yourself, not confirmed breakouts."
      footer={
        <>
