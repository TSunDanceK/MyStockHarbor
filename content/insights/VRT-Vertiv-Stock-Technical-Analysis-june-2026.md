---
title: "VRT Vertiv Stock Rips Back Toward Highs"
date: "2026-06-19"
excerpt: "Vertiv is surging back toward its all-time high after the ThermoKey acquisition closed, putting the May peak back in focus as resistance."
symbol: "VRT"
timeframe: "d"
chartBars: 250
chartIndicators: ["MA50"]
overallBreakdown: "VRT has ripped off its pullback low on real M&A news, so the question now is whether buyers can clear the prior all-time high or stall just under it."
latestNews: "Vertiv completed its acquisition of ThermoKey on June 12, expanding its heat rejection portfolio for AI data centers, and the stock has continued pushing higher on strong volume since."
latestEarnings: "Vertiv's most recent quarter showed full-year revenue growth of nearly 28% and earnings up over 160%, but the next earnings date is not until July 29, so earnings are not the near-term driver of this move."
investorUsefulInfo: "Investors should watch how VRT behaves as it approaches its prior all-time high, since a clean break would confirm renewed trend strength while a stall there would suggest the rally needs to digest recent gains."
---
